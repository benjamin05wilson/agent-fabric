...
class Worker(Base):
    ...
    vram_mb: Mapped[int] = mapped_column(BigInteger, default=0)
    ...
    reserved_gpu_count: Mapped[int] = mapped_column(Integer, default=0)
    reserved_vram_mb: Mapped[int] = mapped_column(BigInteger, default=0)
