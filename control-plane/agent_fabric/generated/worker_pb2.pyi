...
class Register(_message.Message):
    __slots__ = ("protocol_version", "worker_version", "cpu_millis", "memory_mb", "pids", "capabilities", "sandbox_backends")
    ...
    def __init__(self, protocol_version: _Optional[str] = ..., worker_version: _Optional[str] = ..., cpu_millis: _Optional[int] = ..., memory_mb: _Optional[int] = ..., pids: _Optional[int] = ..., capabilities: _Optional[_Iterable[str]] = ..., sandbox_backends: _Optional[_Iterable[str]] = ...) -> None: ...

class Heartbeat(_message.Message):
    __slots__ = ("unix_millis", "active_attempt_ids", "free_cpu_millis", "free_memory_mb")
    ...
    free_cpu_millis: int
    free_memory_mb: int
    def __init__(self, unix_millis: _Optional[int] = ..., active_attempt_ids: _Optional[_Iterable[str]] = ..., free_cpu_millis: _Optional[int] = ..., free_memory_mb: _Optional[int] = ...) -> None: ...
...
class LeaseOffer(_message.Message):
    __slots__ = ("run_id", "attempt_id", "lease_token", "expires_unix_millis", "repository_url", "repository_ref", "argv", "environment", "profile", "image_digest", "cpu_millis", "memory_mb", "pids", "disk_mb", "timeout_seconds", "network_policy", "traceparent")
